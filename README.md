...
File takes in a matrix and vector of any size (>2) and prints the resultant vector while creating an output vector csv. The first argument corresponds to the input matrix csv, the second to the input vector csv, and the third to the output vector csv.
